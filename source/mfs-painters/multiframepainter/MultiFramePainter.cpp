...
, m_angle(0.0f)
{
    ...
    // Register properties
    addProperty<bool>("Animation", this, &MultiFramePainter::animation, &MultiFramePainter::setAnimation);
    addProperty<Color>("BackgroundColor", this, &MultiFramePainter::background, &MultiFramePainter::setBackground);
    addProperty<FilePath>("Texture", this, &MultiFramePainter::texture, &MultiFramePainter::setTexture);
}
...
bool MultiFramePainter::animation() const
{
    return m_animation;
}

void MultiFramePainter::setAnimation(const bool & enabled)
{
    m_animation = enabled;
...
Color MultiFramePainter::background() const
{
    return m_background;
}

void MultiFramePainter::setBackground(const Color & color)
{
    m_background = color;
}

FilePath MultiFramePainter::texture() const
{
    return m_textureFilename;
}

void MultiFramePainter::setTexture(const FilePath & filename)
{
...
void MultiFramePainter::createAndSetupCamera()
{
    m_camera = new Camera();
    m_camera->setEye(glm::vec3(0.0, 0.0, 12.0));
}

void MultiFramePainter::createAndSetupTexture()
{
    // Try to load texture
...
void MultiFramePainter::createAndSetupGeometry()
{
